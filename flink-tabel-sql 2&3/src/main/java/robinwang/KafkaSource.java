...
import robinwang.custom.Tuple1Schema;
...
public class KafkaSource {
    public static void main(String[] args) throws Exception {
        ...
        DataStream<Tuple1<String>> kafkaStream=blinkStreamEnv.addSource(new FlinkKafkaConsumer011<>("test",new Tuple1Schema(),kafkaProperties));
